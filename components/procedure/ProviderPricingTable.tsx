 ...
 * Features search by name, location, or price. Shows 5 providers initially,
 * with "Load more" revealing 5 additional providers at a time.
 */
export function ProviderPricingTable({ procedureSlug, providers }: Props) {
    ...
    const filteredProviders = useMemo(() => {
        ...
        // Check if searching for a price (starts with $ or is a number)
        ...
        return providers.filter(item => {
            ...
            // Match by price range (within 20% of searched price)
                ...
                <div className="mt-3 relative">
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            setDisplayCount(DISPLAY_INCREMENT); // Reset to initial view when searching
                        }}
